          ...
          <form method="POST">
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="number" class="form-control" name="km_inicial" value="<?= $reserva['km_inicial'] ?>" <?= $reserva['km_inicial'] ? 'disabled' : '' ?>>
              </div>
              <div class="col-md-6">
                <label class="form-label">KM Final</label>
                <input type="number" class="form-control" name="km_final" min="<?= $reserva['km_inicial'] + 5 ?>" required>
              </div>
            </div>
